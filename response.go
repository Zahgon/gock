...
func (r *Response) Status(code int) *Response { _ = "STUB: not implemented"; return nil }

// Type defines the response Content-Type MIME header field.
// Supports type alias. E.g: json, xml, form, text...
func (r *Response) Type(kind string) *Response { _ = "STUB: not implemented"; return nil }

// SetHeader sets a new header field in the mock response.
func (r *Response) SetHeader(key, value string) *Response { _ = "STUB: not implemented"; return nil }

// AddHeader adds a new header field in the mock response
// with out removing an existent one.
func (r *Response) AddHeader(key, value string) *Response { _ = "STUB: not implemented"; return nil }
...
func (r *Response) Body(body io.Reader) *Response { _ = "STUB: not implemented"; return nil }
...
func (r *Response) BodyString(body string) *Response { _ = "STUB: not implemented"; return nil }

// File defines the response body reading the data
// from disk based on the file path string.
func (r *Response) File(path string) *Response { _ = "STUB: not implemented"; return nil }

// JSON defines the response body based on a JSON based input.
func (r *Response) JSON(data interface{}) *Response { _ = "STUB: not implemented"; return nil }

// XML defines the response body based on a XML based input.
func (r *Response) XML(data interface{}) *Response { _ = "STUB: not implemented"; return nil }

// SetError defines the response simulated error.
func (r *Response) SetError(err error) *Response { _ = "STUB: not implemented"; return nil }

// Delay defines the response simulated delay.
// This feature is still experimental and will be improved in the future.
func (r *Response) Delay(delay time.Duration) *Response { _ = "STUB: not implemented"; return nil }

// Map adds a new response mapper function to map http.Response before the matching process.
func (r *Response) Map(fn MapResponseFunc) *Response { _ = "STUB: not implemented"; return nil }

// Filter filters a new request filter function to filter http.Request before the matching process.
func (r *Response) Filter(fn FilterResponseFunc) *Response { _ = "STUB: not implemented"; return nil }

// EnableNetworking enables the use real networking for the current mock.
func (r *Response) EnableNetworking() *Response { _ = "STUB: not implemented"; return nil }

// Done returns true if the mock was done and disabled.
func (r *Response) Done() bool { _ = "STUB: not implemented"; return false }
